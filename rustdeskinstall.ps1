### ACCESS via a URI Handler rustdesk://connection/new/10.1.10.12:6969?password=rustdeskclientpass

$ErrorActionPreference= 'silentlycontinue'

# Assign the value random password to the password variable
$rustdesk_pw="rustdeskclientpass"
...
add-content -path "C:\Windows\ServiceProfiles\LocalService\AppData\Roaming\RustDesk\config\rustdesk2.toml" -value @(
"direct-access-port = '6969'",
